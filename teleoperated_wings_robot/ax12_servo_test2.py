...
while True:
  ...
  move_speed(left_h, 0, 1023, Dynamixel)
  move_speed(right_h, 0, 1023, Dynamixel)
  # i = move_check(0x04, 16)         
  sleep(1)
  move_speed(left_h, 300, 500, Dynamixel)
  move_speed(right_h, 300, 500, Dynamixel)
  # i = move_check(0x04, 544)  
  sleep(1)
  move(left_v, 150, Dynamixel)
  move(right_v, 150, Dynamixel)
  sleep(1)
