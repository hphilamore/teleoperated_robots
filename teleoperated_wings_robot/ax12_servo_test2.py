...
while True:
  ...
  # sleep(2)
  # move(left_h, 1023, Dynamixel)
  # move(right_h, 1023, Dynamixel)
  # move(left_v, 1023, Dynamixel)
  # move(right_v, 1023, Dynamixel)
  # sleep(3)
  # move(left_h, 0, Dynamixel)
  # move(right_h, 0, Dynamixel)
  # move(left_v, 0, Dynamixel)
  # move(right_v, 0, Dynamixel)
  sweep(left_v, range(1024), 1023, Dynamixel)
  sweep(left_v, range(1024, 0, -1), 512, Dynamixel)
  sweep(right_v, range(1024), 1023, Dynamixel)
  sweep(right_v, range(1024, 0, -1), 512, Dynamixel)
