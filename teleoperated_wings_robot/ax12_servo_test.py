...
while True:
  ...
  # sleep(1)
  sweep(0x01, range(1024), 0.005, Dynamixel)
  sweep(0x01, range(1024, 0, -1), 0.005, Dynamixel)
  sweep(0x02, range(1024), 0.005, Dynamixel)
  sweep(0x02, range(1024, 0, -1), 0.005, Dynamixel)
  sweep(0x03, range(1024), 0.005, Dynamixel)
  sweep(0x03, range(1024, 0, -1), 0.005, Dynamixel)
  sweep(0x04, range(1024), 0.005, Dynamixel)
  sweep(0x04, range(1024, 0, -1), 0.005, Dynamixel)
